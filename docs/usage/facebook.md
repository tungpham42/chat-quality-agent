...
CQATP cần **Page ID** và **Page Access Token** của fanpage để lấy tin nhắn từ Messenger.
...
### Bước 1.6: Nhập vào CQATP

Trong CQATP, vào **Kênh chat** → **Kết nối kênh mới** → chọn **Facebook**:

- **Page ID**: số đã lấy ở Bước 1.2
- **Page Access Token**: token đã tạo ở Bước 1.5

![Nhập vào CQATP](/screenshots/facebook/Fb-fanpage-13.png)
...
![Đổi token](/screenshots/facebook/Fb-fanpage-18.png)

### Bước 2.5: Nhập vào CQATP
...
::: info CQATP tự đổi sang Page Token
Bạn chỉ cần nhập Long-lived User Token. CQATP sẽ tự động gọi Facebook API để đổi sang Page Token vĩnh viễn và lưu lại. Không cần đổi thủ công.
:::
...
Sau khi nhập Page ID và Token, CQATP tự động kiểm tra kết nối. Nếu thành công, bạn sẽ thấy trạng thái **"Hoạt động"** cùng với tên fanpage.
