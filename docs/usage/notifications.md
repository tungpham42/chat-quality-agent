...
CQATP gửi kết quả phân tích qua **Telegram** và/hoặc **Email** sau mỗi lần chạy công việc.
...
- **Link**: Đường dẫn đến trang kết quả trên CQATP
